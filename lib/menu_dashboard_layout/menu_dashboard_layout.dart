...
final Color backgroundColor = Color.fromRGBO(12,31, 52 ,1);
...
class _MenuDashboardLayoutState extends State<MenuDashboardLayout> with SingleTickerProviderStateMixin {
  ...
  int findSelectedIndex(NavigationStates navigationState) {
    if (navigationState is MyCardsPage) {
      ...
      return 1;
    } else if (navigationState is myrole) {
      return 2;
    } else if (navigationState is history) {
      return 3;
    } else if (navigationState is notification) {
      return 4;
    } else if (navigationState is setting) {
      return 5;
    } else if (navigationState is logout) {
      return 6;
    }
